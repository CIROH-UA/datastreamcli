...
def test_realization_parsing_sloth_nom_cfe_pet_troute():
    ...
    try:
        ...
        raise AssertionError(
            f"Failed to parse NOM/CFE/PET/troute realization file: {REALIZATION_FILE}"
        )
...
def test_realization_parsing_lstm_lstm_troute():
    ...
    try:
        ...
        raise AssertionError(
            f"Failed to parse rust lstm realization file: {REALIZATION_FILE}"
        )
...
def test_realization_parsing_sloth_troute():
    ...
    try:
        ...
        raise AssertionError(
            f"Failed to parse sloth/troute realization file: {REALIZATION_FILE}"
        )
