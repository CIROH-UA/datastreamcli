...
def test_forcings_time_axis():
    del_file = str(TEST_DATA_DIR) + '/forcings/*.nc'
    os.system(f"rm {del_file}")
    os.system(f"curl -L -O https://ciroh-community-ngen-datastream.s3.amazonaws.com/v2.2/ngen.20251006/forcing_short_range/02/ngen.t02z.short_range.forcing.f001_f018.VPU_09.nc")
    ...
    try:
        ...
        assert inst.__str__() == f"Realization start time 2025-02-28 01:00:00+00:00 does not match forcing start time 2025-10-06 03:00:00+00:00"          
