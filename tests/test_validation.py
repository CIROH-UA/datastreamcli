...
def test_forcings_time_axis():
    del_file = str(TEST_DATA_DIR) + '/forcings/*.nc'
    os.system(f"rm {del_file}")
    os.system(f"curl -L -O https://ciroh-community-ngen-datastream.s3.amazonaws.com/forcings/v2.2_hydrofabric/ngen.20260101/forcing_short_range/02/ngen.t02z.short_range.forcing.f001_f018.VPU_09.nc")
